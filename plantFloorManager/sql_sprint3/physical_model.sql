...
DROP TABLE OrderProductList CASCADE CONSTRAINTS;
DROP TABLE Supplier CASCADE CONSTRAINTS;
DROP TABLE MaterialProcurement CASCADE CONSTRAINTS;
DROP TABLE Material CASCADE CONSTRAINTS;
DROP TABLE FinalProduct CASCADE CONSTRAINTS;
DROP TABLE IntermediaryProduct CASCADE CONSTRAINTS;
DROP TABLE FactoryItem CASCADE CONSTRAINTS;
DROP TABLE Operation_InputList CASCADE CONSTRAINTS;
DROP TABLE MaterialStock CASCADE CONSTRAINTS;
DROP TABLE MaterialReservation CASCADE CONSTRAINTS;
